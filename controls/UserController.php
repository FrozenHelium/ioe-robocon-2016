...
class UserController extends Controller
{
    public function get()
    {
        ...
        return new View($this->model, 'base.html');
    }

    // Try url /user/add/Bibek/Dahal/
    // Then check out the index <id> of new user from phpmyadmin
    // Then try url /user/add/Not_Bibek/Not_Dahal/<id>

    public function get_add($a="", $b="", $id=null)
    {
